...
create table tbVagas(
	...
	requisitos_vagas text unique,
	salario_vagas DECIMAL (10),
	vinculo_vagas varchar (50),
	beneficios_vagas text unique,
...
create table tbCurriculo(
	...
	exper_profissional_curriculo text unique,
	exper_academico_curriculo text unique,
...
-- Inserindo dados na tabela tbCandidatos
...
-- Inserindo dados na tabela tbCurriculo
...
-- Inserindo dados na tabela tbVagas
insert into tbVagas (local_vagas, requisitos_vagas, salario_vagas, vinculo_vagas, beneficios_vagas, ramo_vagas, id_empresa)
values 
('Local A', 'Experiência em TI', 5000.00, 'CLT', 'Vale Transporte', 'Tecnologia', 1),
('Local B', 'Experiência em Marketing', 4000.00, 'PJ', 'Vale Alimentação', 'Marketing', 2);